...
- Tableau Server integration roadmap: optional Connected-App/JWT, REST and Metadata API features are tracked in [docs/tableau-server-integration.md](docs/tableau-server-integration.md).
