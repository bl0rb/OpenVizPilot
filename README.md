...
- Tableau Server integration (Enterprise): optional Connected-App/JWT sign-in, REST content search and Metadata API are implemented for Tableau Server 2024.2 or newer; status and scope are documented in [docs/tableau-server-integration.md](docs/tableau-server-integration.md).
